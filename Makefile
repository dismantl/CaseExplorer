...
BACKEND_API_DEPS=$(addprefix $(BACKEND_DIR)/app/api/,__init__.py cases.py cc.py dscivil.py dscr.py dsk8.py dstraf.py interface.py odycrim.py odytraf.py odycvcit.py odycivil.py schema_factory.py)
